...
sed -i '/"_custom")/a attr("checked", "checked") ..' feeds/luci/modules/luci-base/luasrc/view/cbi/network_ifacelist.htm
sed -i 's#attr("value", " ")#attr("value", wifi_infs)#' feeds/luci/modules/luci-base/luasrc/view/cbi/network_ifacelist.htm
sed -i "s/_custom').checked=true/_custom').checked=true\" value=\"<%=wifi_infs%>/" feeds/luci/modules/luci-base/luasrc/view/cbi/network_ifacelist.htm
